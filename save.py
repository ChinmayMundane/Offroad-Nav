...
class SuperpixelGUI:
    def __init__(self, master):
        ...
        self.superpixel_entry = tk.Entry(self.master)
        self.superpixel_entry.pack()
    ...
    def generate_superpixels(self):
        num_segments = int(self.superpixel_entry.get())
        self.superpixels = slic(np.array(self.image), n_segments=num_segments, compactness=25)
